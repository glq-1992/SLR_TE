    ...
    def __init__(self, model, optim_dict):
        ...
        if self.optim_dict["optimizer"] == 'SGD':
            ...
            self.optimizer = optim.Adam(
                ...
                #     {'params': model.conv1d_combine_first.parameters()},
                #     {'params': model.temporal_model_combine_first.parameters()},   ####缺少generator,看一下generator的梯度
                #     {'params': model.G.parameters()},  ####缺少generator,看一下generator的梯度
                # ],
